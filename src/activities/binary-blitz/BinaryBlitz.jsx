      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        ...
        {screen === 'intro' && (
          <div style={{ textAlign: 'center', animation: 'pop 0.4s ease' }}>
            ...
            <h1 style={{ fontFamily: 'Archivo, sans-serif', fontSize: '2.5rem', fontWeight: 700, color: '#0f0f0f', marginBottom: '0.5rem' }}>Binary Blitz</h1>
            ...
            <p style={{ color: '#aaa', fontSize: '0.85rem', marginBottom: '2.5rem', fontFamily: 'IBM Plex Mono, monospace' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginBottom: '2.5rem', flexWrap: 'wrap' }}>
              {LEVELS.map((l, i) => (
                <div key={i} style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '10px', padding: '0.8rem 1.2rem', textAlign: 'center' }}>
                  <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '13px', fontWeight: 700, color: '#0f0f0f' }}>{l.label}</div>
                  <div style={{ fontSize: '11px', color: '#aaa', marginTop: '2px' }}>{l.time}s per question</div>
                </div>
              ))}
            </div>

            <button onClick={startGame} style={{ background: '#0f0f0f', color: '#fff', border: 'none', borderRadius: '10px', padding: '1rem 3rem', fontSize: '1rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'Archivo, sans-serif', letterSpacing: '0.02em' }}>
              Start playing →
            </button>

            {best > 0 && (
              <div style={{ marginTop: '1.5rem', fontFamily: 'IBM Plex Mono, monospace', fontSize: '12px', color: '#aaa' }}>
        ...
        {(screen === 'playing' || screen === 'correct' || screen === 'wrong') && question && (
          <div style={{ textAlign: 'center', width: '100%', maxWidth: '560px', animation: screen === 'playing' ? 'pop 0.3s ease' : screen === 'wrong' ? 'shake 0.4s ease' : undefined }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '12px', padding: '0.8rem 1.2rem' }}>
              <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '13px', color: '#888' }}>
            ...
            {/* Level badge */}
            <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '10px', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#aaa', marginBottom: '1rem' }}>
            ...
            {feedback && screen === 'correct' && (
              <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '13px', color: '#16a34a', marginBottom: '1rem', animation: 'pop 0.3s ease' }}>
                ✓ correct! {feedback}
              </div>
            )}
            {screen === 'wrong' && (
              <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '13px', color: '#dc2626', marginBottom: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center' }}>
              ...
              <button
                ...
                disabled={screen !== 'playing'}
                style={{ background: '#0f0f0f', color: '#fff', border: 'none', borderRadius: '10px', padding: '0.85rem 1.5rem', fontSize: '1rem', cursor: 'pointer', fontFamily: 'Archivo, sans-serif', fontWeight: 600, opacity: screen !== 'playing' ? 0.5 : 1 }}
              >
                Submit
              </button>
            </div>
            ...
            {/* Hint */}
            <div style={{ marginTop: '1.5rem', fontFamily: 'IBM Plex Mono, monospace', fontSize: '11px', color: '#ccc' }}>
        ...
        {screen === 'gameover' && (
          <div style={{ textAlign: 'center', animation: 'pop 0.5s ease' }}>
            ...
            <h2 style={{ fontFamily: 'Archivo, sans-serif', fontSize: '2rem', fontWeight: 700, color: '#0f0f0f', marginBottom: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', margin: '2rem 0', flexWrap: 'wrap' }}>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '12px', padding: '1.2rem 2rem', textAlign: 'center' }}>
                <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '2rem', fontWeight: 700, color: '#0f0f0f' }}>{score}</div>
                <div style={{ fontSize: '12px', color: '#aaa', marginTop: '4px' }}>your score</div>
              </div>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '12px', padding: '1.2rem 2rem', textAlign: 'center' }}>
                <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '2rem', fontWeight: 700, color: '#f59e0b' }}>{Math.max(score, best)}</div>
                <div style={{ fontSize: '12px', color: '#aaa', marginTop: '4px' }}>personal best</div>
              </div>
              <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '12px', padding: '1.2rem 2rem', textAlign: 'center' }}>
                <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '2rem', fontWeight: 700, color: '#2563EB' }}>{questionNum}</div>
                <div style={{ fontSize: '12px', color: '#aaa', marginTop: '4px' }}>questions answered</div>
              </div>
            </div>

            <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center' }}>
              <button onClick={startGame} style={{ background: '#0f0f0f', color: '#fff', border: 'none', borderRadius: '10px', padding: '0.9rem 2rem', fontSize: '0.95rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'Archivo, sans-serif' }}>
                Play again
              </button>
              <button onClick={() => navigate('/playground')} style={{ background: '#fff', color: '#0f0f0f', border: '1px solid rgba(0,0,0,0.12)', borderRadius: '10px', padding: '0.9rem 2rem', fontSize: '0.95rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'Archivo, sans-serif' }}>
                Back to home
              </button>
            </div>
          </div>
